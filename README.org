...
* Screenshots
All screenshots have been taken calling =consult-project=, which I have bound to a keybinding.
...
#+begin_src emacs-lisp
  (use-package consult-project-extra
    ...
    :bind
    (("C-c p f" . consult-project)
     ("C-c p o" . consult-project-other-window)))
#+end_src
